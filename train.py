...
def create_lava_model(input_shape):
    model = Sequential([
        ...
        # 3-5 conv layers
        Conv2D(384, kernel_size=3, strides=(1, 1), activation='relu', padding='valid'),
        Conv2D(384, kerner_size=3, strides=(1, 1), activation='relu', padding='valid'),
        Conv2D(256, kerner_size=3, strides=(1, 1), activation='relu', padding='valid'),
        MaxPooling2D(pool_size=(3, 3), strides=(2, 2)),
        BatchNormalization(),
